    ...
    <>
      {cards === undefined ? (
        ...
        cards.map(({
          ...
          const entitiesTitle = data?.[0].cards?.[0].formatted_title.text.replace("{}", data?.[0].cards?.[0].formatted_title.entities?.[0].text)
          const formattedTitle = entitiesTitle.replace("{}", data?.[0].cards?.[0].formatted_title.entities?.[1].text)
          ...
          {cards === undefined  ? (
            ...
            <HC3CardWrapper>
              ...
              >
                ...
                <p>{ data?.[0].cards?.[0].formatted_description.text  || description}</p>
                <a href={cta.url}>
                  <button
                    style={{
